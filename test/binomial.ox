...
binomial_pricing()
{
	...
	set_parameters(spot, exercise, r, sigma, time, steps, dividend_times, dividend_yields, dividend_amounts);
...
//	    	spot,exercise,r,sigma,time_to_maturity,steps,dividend_times, dividend_yields
    ...
    println(" american call, dividends 2.5 2.5, price= ",
		option_price_american_discrete_dividends_binomial(option[0], spot, time, steps, dividend_times, dividend_amounts));
    println(" american put, dividends 2.5 2.5, price= ",
		option_price_american_discrete_dividends_binomial(option[1], spot, time, steps, dividend_times, dividend_amounts));
