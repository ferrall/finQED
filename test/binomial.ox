...
binomial_pricing()
{
    ...
    println(" american ");
    println(" call: ", option_price_call_american_binomial(S, r, sigma, time, steps, dividend_times, dividend_amounts) );
    println(" put: ", option_price_put_american_binomial(S, r, sigma, time, steps, dividend_times, dividend_amounts) );
