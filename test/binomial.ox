...
binomial_pricing()
{
    ...
    println(" american ");
    println(" call: ", option_price_american_binomial(option[0], S, r, sigma, time, steps, dividend_times, dividend_amounts) );
    println(" put: ", option_price_american_binomial(option[1], S, r, sigma, time, steps, dividend_times, dividend_amounts) );
